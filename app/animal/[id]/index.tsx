        ...
        <View className="flex flex-row border border-neutral-200 rounded-xl p-2 space-x-4 items-center">
          ...
          <View className="flex flex-col max-w-[74%]">
            <Text
              ...
              numberOfLines={1}
            >
              Ghufron Akbar Ghufron Akbar Ghufron Akbar{" "}
            </Text>
            <Text
        ...
        <View className="flex flex-col space-y-2">
          ...
          <View>
            ...
            >
              ...
              veritatis, neque fugit quisquam illo, voluptas doloremque quam,
              corrupti dolor ipsa architecto itaque? Repellat vitae sequi minus
              ut dignissimos placeat, iusto maiores, maxime odit, doloremque
              sunt! Consequuntur odit voluptate aut unde corrupti nihil a saepe
              suscipit aliquam. Officia nesciunt vero rem ea consequatur enim
              iusto suscipit quis magnam illum! Cumque, tempora obcaecati
              voluptas error quis expedita perferendis consectetur fugiat facere
              sed at quae omnis iure eum. Vel distinctio soluta cupiditate
              necessitatibus iure odit. Neque rem mollitia excepturi magnam,
              esse adipisci necessitatibus, eius debitis incidunt deleniti
              itaque odio rerum doloremque dolores quae?
            </Text>
          </View>
        </View>
      </View>
